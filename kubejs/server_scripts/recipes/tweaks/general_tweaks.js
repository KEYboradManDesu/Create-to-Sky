onEvent("recipes", event => {
  ...
  event.remove({ output: 'twilightforest:hollow_birch_log' })
  event.remove({ output: 'twilightforest:hollow_jungle_log' })
  event.remove({ output: 'twilightforest:hollow_acacia_log' })
  event.remove({ output: 'twilightforest:hollow_dark_oak_log' })
  event.remove({ output: 'twilightforest:hollow_crimson_stem' })
  event.remove({ output: 'twilightforest:hollow_warped_stem' })
  event.remove({ output: 'twilightforest:hollow_twilight_oak_log' })
  event.remove({ output: 'twilightforest:hollow_oak_log' })
  event.remove({ output: 'twilightforest:hollow_canopy_log' })
  event.remove({ output: 'twilightforest:hollow_mangrove_log' })
  event.remove({ output: 'twilightforest:hollow_dark_log' })
  event.remove({ output: 'twilightforest:hollow_time_log' })
  event.remove({ output: 'twilightforest:hollow_transformation_log' })
  event.remove({ output: 'twilightforest:hollow_mining_log' })
  event.remove({ output: 'twilightforest:hollow_sorting_log' })
  ...
  event.remove({ id: "create:fill_minecraft_bucket_with_kubejs_cryo_fuel" })
  ...
  event.remove({ id: 'projecte:dark_matter' })//删除物质球等价交换原版合成
  event.remove({ id: 'projecte:red_matter' })
  event.remove({ id: 'projecte:red_matter_alt' })

  event.remove({ id: 'projecte:klein_star_ein' })//删除能量之星配方
...
event.recipes.createFilling('create_sa:brass_hoe', ['create_sa:brass_hoe', {fluid: 'tconstruct:molten_diamond', amount: 50}]),
  ...
  event.shapeless('10x kubejs:black_gunpowder', ['minecraft:gunpowder', '#forge:dusts/charcoal', '#forge:dusts/niter', '#forge:dusts/sulfur']).id("kubejs:black_gunpowder")
  event.shapeless('4x createbigcannons:packed_gunpowder', ['minecraft:gunpowder', 'minecraft:gunpowder', 'minecraft:gunpowder', 'kubejs:black_gunpowder', 'kubejs:black_gunpowder']).id("kubejs:packed_gunpowder")
  //event.shapeless('2x createbigcannons:packed_gunpowder', ['minecraft:gunpowder', 'minecraft:gunpowder', 'minecraft:gunpowder', 'minecraft:gunpowder', 'minecraft:gunpowder', 'minecraft:gunpowder', 'minecraft:gunpowder', 'minecraft:gunpowder']).id("kubejs:packed_gunpowder_2")
  event.shapeless('6x createbigcannons:shot_balls', ['#forge:nuggets/iron', '#forge:nuggets/iron', '#forge:nuggets/iron', '#forge:nuggets/iron', '#forge:nuggets/iron', '#forge:nuggets/iron']).id("kubejs:shot_balls")
  ...
  event.shapeless('musketmod:musket', ['kubejs:stock', 'kubejs:musket_barrel', 'kubejs:sealed_mechanism']).id("kubejs:musket")//火铳
  ...
  event.shaped(Item.of("immersiveengineering:empty_shell", 3), [
    "C",
    "D",
    "A"
  ], {
  ...
  event.recipes.createMechanicalCrafting(Item.of("immersiveengineering:empty_casing", 4), [
    "D"
  ], {
    D: '#forge:plates/copper'
  })
  event.shapeless('4x immersiveengineering:empty_casing', ['#forge:plates/copper', 'immersiveengineering:hammer']).id("kubejs:im_empty_casing") //小型空弹壳配方相关

  event.recipes.createMechanicalCrafting(Item.of("kubejs:empty_casing", 3), [
    "D"
  ], {
    D: '#forge:plates/brass'
  })
  event.shapeless('3x kubejs:empty_casing', ['#forge:plates/brass', 'immersiveengineering:hammer']).id("kubejs:empty_casing") //中型空弹壳配方相关
  
  event.shaped("64x cgm:basic_bullet", [
    "L"
  ], {
    L: 'kubejs:incomplete_box_nails'
  })
  event.shaped("64x cgm:advanced_bullet", [
    "L"
  ], {
    L: 'kubejs:incomplete_box_ammo'
  })
  event.shaped("64x cgm:shell", [
    "L"
  ], {
    L: 'kubejs:incomplete_box_shell'
  })
  event.shaped("48x kubejs:armour_piercing_buttle", [
    "L"
  ], {
    L: 'kubejs:incomplete_box_ap_ammo'
  }) //弹药拆盒
  event.shaped("kubejs:box_ammo", [
    "LB"
  ], {
    L: 'kubejs:incomplete_box_ammo',
    B: 'immersiveengineering:wirecutter'
  })
  event.shaped("kubejs:box_ap_ammo", [
    "LB"
  ], {
    L: 'kubejs:incomplete_box_ap_ammo',
    B: 'immersiveengineering:wirecutter'
  })
  event.shaped("kubejs:box_nails", [
    "LB"
  ], {
    L: 'kubejs:incomplete_box_nails',
    B: 'immersiveengineering:wirecutter'
  })
  event.shaped("kubejs:box_shell", [
    "LB"
  ], {
    L: 'kubejs:incomplete_box_shell',
    B: 'immersiveengineering:wirecutter'
  }) //弹药封装
  event.shaped("kubejs:incomplete_box_ammo", [
    "L"
  ], {
    L: 'kubejs:box_ammo'
  })
  event.shaped("kubejs:incomplete_box_ap_ammo", [
    "L"
  ], {
    L: 'kubejs:box_ap_ammo'
  })
  event.shaped("kubejs:incomplete_box_nails", [
    "L"
  ], {
    L: 'kubejs:box_nails'
  })
  event.shaped("kubejs:incomplete_box_shell", [
    "L"
  ], {
    L: 'kubejs:box_shell'
  }) //弹药拆封
  ...
  event.shapeless('9x kubejs:compressed_limestone', ['kubejs:double_compressed_limestone']).id("kubejs:compressed_limestone")
  event.shaped("kubejs:compressed_limestone", [
    "BBB",
    "BBB",
    "BBB"], {B: 'create:limestone'})
  event.shaped("kubejs:double_compressed_limestone", [
    "BBB",
    "BBB",
    "BBB"], {B: 'kubejs:compressed_limestone'})
  event.shaped("kubejs:double_compressed_andesite", [
    "BBB",
    "BBB",
    "BBB"], {B: 'excompressum:compressed_andesite'})
  ...
  event.shapeless('4x forbidden_arcanus:soul', ['quark:soul_bead']).id("kubejs:soul")
  ...
  event.recipes.createCrushing([Item.of("minecraft:sand", 2), Item.of("immersiveengineering:dust_saltpeter", 1).withChance(.55)], "minecraft:sandstone")//磨砂岩出硝酸盐
 ...
 //前期发电相关
  ...
  event.smithing(Item.of('thermal:dynamo_stirling', 1), 'createaddition:alternator', 'create_sa:heat_engine')
  event.recipes.createMechanicalCrafting(Item.of('thermal:dynamo_stirling', 1), "AB", { A: 'createaddition:alternator', B: 'create_sa:heat_engine' })

  event.remove({ id: 'createaddition:crafting/connector' })
  event.shapeless('createaddition:connector', ['create:andesite_alloy', '#forge:rods/copper']).id("kubejs/crafting/connector")

  event.recipes.createMechanicalCrafting(Item.of('createaddition:capacitor', 2), [
  "B",
  "A",
  "C" ], 
  { A: '#forge:plates/copper', B: '#forge:plates/zinc', C: 'minecraft:redstone' })
...
event.shaped(('buddycards:luminis_sleeve'), [
  ...
  event.recipes.createSequencedAssembly([
   ...
   let b = "minecraft:phantom_membrane"
  event.recipes.createSequencedAssembly([
    "kubejs:elytra_broken",
  ], "minecraft:phantom_membrane", [
     event.recipes.createPressing(b, b)
  ]).transitionalItem(b)
     .loops(150)
     .id("kubejs:elytra_broken")

     let e = "kubejs:netherite_plating"
    event.recipes.createSequencedAssembly([
       "minecraft:netherite_scrap",
    ], "kubejs:netherite_plating", [
...
//      event.remove({ input: "#forge:ores/" + name, type: TE("pulverizer") })
  ...
  event.custom({
    ...
    event.custom({
    "type": "thermal:smelter",
    "ingredients": [{"item": "avaritia:neutron_nugget"},{"tag": "forge:dusts/iron"}],
    "result": [{"item": "projecte:medium_covalence_dust"}],
    "energy": 15000
  })
    event.custom({
    "type": "thermal:smelter",
    "ingredients": [{"item": "avaritia:neutron_nugget"},{"tag": "forge:dusts/diamond"}],
