...
onEvent('item.registry', event => {
	...
	profession("厨师", "Cooking", 0xD8B384, 0xF7DAD9, [
		...
		{ in: CRCO('bar_of_black_chocolate', 16), out: S(4) },
		{ in: CRCO('bar_of_white_chocolate', 16), out: S(4) },
		{ in: CRCO('bar_of_ruby_chocolate', 16), out: S(6) },
		...
		{ in: CRCO('ruby_chocolate_glazed_berries', 16), out: S(8) },
		{ in: CRCO('white_chocolate_glazed_berries', 16), out: S(6) },
